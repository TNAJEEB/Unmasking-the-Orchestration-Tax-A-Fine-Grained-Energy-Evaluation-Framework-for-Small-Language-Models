...
if __name__ == "__main__":
    ...
    for MODEL_NAME in MODEL_LIST:
        ...
        # =======================================================
        # NEW CODE: CATEGORY 5 - INT4 QUANTIZATION 
        # =======================================================
        ...
        # =======================================================
        # NEW CODE: ADDED _INT4_ TO ALL CSV FILENAMES
        # =======================================================
        for d in OUTPUT_DIRS:
            # 1. Update Lifecycle CSV
            cat2_file = os.path.join(d, f"{clean_name}_INT4_Cat2_Lifecycle.csv")
        ...
        print("\nStarting Main Inference Run (Categories 1, 3, 5, and 6)...")
        
        # 2. Update Main Inference and Error Log CSVs
        main_csv_paths = [os.path.join(d, f"{clean_name}_INT4_Cat1_3_5_6_Inference.csv") for d in OUTPUT_DIRS]
        error_log_paths = [os.path.join(d, f"{clean_name}_INT4_Error_Log.csv") for d in OUTPUT_DIRS]
        # =======================================================
